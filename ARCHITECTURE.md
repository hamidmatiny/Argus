...
- **Phases 1–9 (local compose):** messaging → ingestion → QA → drift → lakehouse → Dagster/MLflow → incident-engine → observability → api-gateway (gRPC/REST, Keycloak OIDC, OPA)
- **Later phases:** dashboard, copilot, cloud infra
